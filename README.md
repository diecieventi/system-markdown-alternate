...
- **Custom taxonomies in the front matter** (optional, off by default): appends a `taxonomies:` block listing the post type's public custom taxonomies and their terms, alphabetically ordered. Categories and tags keep their own keys.
