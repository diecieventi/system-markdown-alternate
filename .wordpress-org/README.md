...
Screenshots 1–4 were recaptured from a real WordPress admin session running
**0.53.0** on 14 September 2026, after the removal of `/llms.txt`. They show
all four current tabs with their complete panels. Screenshot 5 remains current.
